    ...
    <div class="principal">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active fw-bold text-danger" href="../Cliente/solicitudes.php">Solicitudes</a>
              </li>
              <li class="nav-item">
      ...
      <ul class="nav nav-tabs m-5" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
          <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#Recbidas" type="button" role="tab" aria-controls="Recbidas" aria-selected="true">RECIBIDAS</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#Aceptadas" type="button" role="tab" aria-controls="Aceptadas" aria-selected="false">ACEPTADAS</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#Entregas" type="button" role="tab" aria-controls="Entregas" aria-selected="false">ENTREGADAS</button>
        </li>
      </ul>
      <?php require_once '../Consultas/getSolicitudes.php'; ?>
    </div>
  </main>
